...
// function for the game flow per player according to the player's money
...
//Chance cards draw and result change
...
//Community cards draw and result change
Monopoly.handleCommunityCard = function (player) {
    var popup = Monopoly.getPopup("community");
    popup.find(".pop-content").addClass("loading-state");
...
// when the player made a full turn of the board
